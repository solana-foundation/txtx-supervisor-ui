...
export enum CatalystButtonColors {
  'dark/zinc' = 'dark/zinc',
  light = 'light',
...
const styles = {
  base: [
    ...
    // Sizing
    `
      px-[calc(theme(spacing[3.5])-1px)] py-[calc(theme(spacing[2.5])-1px)] sm:px-[calc(theme(spacing.3)-1px)]
    ...
    `
      ...
      [&>[data-slot=icon]]:shrink-0 [&>[data-slot=icon]]:text-[--btn-icon] [&>[data-slot=icon]]:sm:my-1 [&>[data-slot=icon]]:sm:size-4 forced-colors:[--btn-icon:ButtonText] forced-colors:data-[hover]:[--btn-icon:ButtonText]
    `,
  ],
  solid: [
  ...
  outline: [
    ...
    // Dark mode
    `
      dark:border-white/15 dark:text-white dark:[--btn-bg:transparent] dark:data-[active]:bg-white/5
      dark:data-[hover]:bg-white/5
    `,
    // Icon
    `
      [--btn-icon:theme(colors.zinc.500)] data-[active]:[--btn-icon:theme(colors.zinc.700)]
      data-[hover]:[--btn-icon:theme(colors.zinc.700)] dark:data-[active]:[--btn-icon:theme(colors.zinc.400)]
  ...
  colors: {
    [CatalystButtonColors['dark/zinc']]: `
    ...
    [CatalystButtonColors.light]: `
      ...
      [--btn-icon:theme(colors.zinc.500)] data-[active]:[--btn-icon:theme(colors.zinc.700)] data-[hover]:[--btn-icon:theme(colors.zinc.700)] dark:[--btn-icon:theme(colors.zinc.500)] dark:data-[active]:[--btn-icon:theme(colors.zinc.400)] dark:data-[hover]:[--btn-icon:theme(colors.zinc.400)]
    `,
    [CatalystButtonColors['dark/white']]: `
      text-white [--btn-bg:theme(colors.zinc.900)] [--btn-border:theme(colors.zinc.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]
...
export const CatalystButton = forwardRef(function CatalystButton(
  ...
  return 'href' in props
    ...
    : (
      <Headless.Button {...props} className={classnames('cursor-default', classes)} ref={ref}>
        <CatalystTouchTarget>
          {children}
        </CatalystTouchTarget>
      </Headless.Button>
